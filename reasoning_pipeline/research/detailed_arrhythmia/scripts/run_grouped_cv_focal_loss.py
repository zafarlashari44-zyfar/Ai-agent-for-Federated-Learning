...
def train_fold(
    ...
    class_weights = (
        calculate_class_weights(
            ...
            method=(
                config.class_weight_method
            ),
            effective_number_beta=(
                config.effective_number_beta
            ),
        )
    )
...
def main() -> None:
    ...
    print("=" * 70)
    print("Experiment F")
    print("Grouped CV with focal loss")
    print("=" * 70)
